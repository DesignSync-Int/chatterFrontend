describe('Buy Request Feature', () => {
  ...
  it("should always show floating buy button", () => {
    // Button should be visible regardless of query parameters
    cy.get('[data-cy="floating-buy-button"]').should("be.visible");
    cy.get('[data-cy="floating-buy-button"]').should(
      "contain.text",
      "Buy or Hire"
    );
  });
  ...
  it('should show floating buy button when ?buy=true is present', () => {
    // Visit with buy query parameter - button should still be visible
  ...
  it("should validate required fields", () => {
    ...
    cy.get('[data-cy="buy-form-contact"]').should(
      "have.class",
      "border-red-500"
    );
    cy.get('[data-cy="buy-form-email"]').should("have.class", "border-red-500");
    cy.get('[data-cy="buy-form-description"]').should(
      "have.class",
      "border-red-500"
    );
  });
  ...
  it("should test email field behavior", () => {
    ...
    cy.get('[data-cy="buy-form-email"]').should(
      "have.value",
      "test@example.com"
    );
  ...
  it("should test form submission button behavior", () => {
    ...
    cy.get('[data-cy="buy-form-description"]').type(
      "I want to buy this application for my company."
    );
  ...
  it("should show form header and description", () => {
    ...
    cy.contains(
      "Purchase this application for your product or hire me for your project"
    ).should("be.visible");
  });
  ...
  it("should show proper placeholder text for all fields", () => {
    ...
    // Check placeholders
    cy.get('[data-cy="buy-form-name"]').should(
      "have.attr",
      "placeholder",
      "Enter your name"
    );
    ...
    cy.get('[data-cy="buy-form-description"]').should(
      "have.attr",
      "placeholder",
      "Describe what you need: buy this application for your product or hire me for your project..."
    );
  });
  ...
  it("should test form field accessibility and behavior", () => {
    ...
    cy.get('[data-cy="buy-form-name"]')
      .should("not.be.disabled")
      .type("John Doe");
    cy.get('[data-cy="buy-form-contact"]')
      .should("not.be.disabled")
      .type("1234567890");
    cy.get('[data-cy="buy-form-email"]')
      .should("not.be.disabled")
      .type("john@example.com");
    cy.get('[data-cy="buy-form-time"]')
      .should("not.be.disabled")
      .select("morning");
    cy.get('[data-cy="buy-form-description"]')
      .should("not.be.disabled")
      .type("I want to buy this application for my company.");
